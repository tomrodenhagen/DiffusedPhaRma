...
{ 
  ...
  return(list(rejected = emp_quantile < T_statistic(estimated_params_H1), H1_lh = H1_fit$f, all_samples = na.omit(T_samples), 
	      t_statistic = T_statistic(estimated_params_H1),quantile=emp_quantile  ,na_samples= sum(is.na(T_samples)) ))
}
visualize_setting= function(drift, diffusion, model_H0, model_H1, T_statistic, sample_params, design, h, path, draw_Km=FALSE)
{ 
...
library(progress)
run_simulation_study = function(drift, diffusion, model_H0, model_H1, T_statistic, sample_params, design, n_param_samples, n_simulations,  alpha, log_path,  h=0.1)
{ 
...
set_up_scenario_folder = function(scenario, path, fresh)
{
  ...
  return(list("scenario_folder" = scenario_folder, 
	      "typ1_folder" = typ1_folder, 
	      "typ2_folder" = typ2_folder))
}
...
#Type 1 Error
 ...
 {print("Run type1 testing...")
  res_type_1 = run_simulation_study(scenario$H0_drift,
                             ...
                             scenario$T_statistic, 
                             scenario$sample_params, 
                             scenario$design, n_tests_typ1, n_samples, alpha, folders$typ2_folder, h=h)
 ...
 {print("Running type 2 testing...")
  res_type_2 = run_simulation_study(scenario$H1_drift,
                             ...
                             scenario$T_statistic, 
                             scenario$sample_params, 
                             scenario$design, n_tests_typ2, n_samples, alpha,folders$typ2_folder, h=h)

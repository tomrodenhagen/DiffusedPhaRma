...
data_H0 = simulate_model(H0_drift, function(...){0}, params, 0, 5, 500, h=0.01, dosis)
data_H1 = simulate_model(H1_drift, function(...){0}, params, 0, 5, 500, h=0.01, dosis)
print(data_obs)

plot(data_H1[["t"]], data_H1[["ConcObserved"]], type="l", col="green",xlab = "Time", ylab = "Concentration")
lines(data_H0[["t"]], data_H0[["ConcObserved"]], col="red")
abline( h=4,lty = "dashed", col="blue"      )
legend( x= "topright", legend=c("Linear Model", "Nonlinear Model", "Km"),
        col=c("red","green", "blue"), lty=1:2, cex=1,pch=19)
plot(data_H1[["t"]], log(data_H1[["ConcObserved"]]), type="l", col="green",xlab = "Time", ylab = "Log of Concentration")

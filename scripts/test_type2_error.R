...
{ 
  ...
  Conc0 = runif(1, 0.5, 3)
  Km = runif(1, 0.5, 3)
  return(list("sigma_eps"=0.001, "sigma_tau"=0, "CL"=CL, "Conc0"=Conc0, "Km"= Km))
  }

rec = run_simulation_study(function(t, state, u, params){return(-params$CL * params$Km / (params$Km + state) *  state)},
                     diffusion = function(t, state, u , params){return(0)},
                     model_H0, model_H1, T_statistic, sampling, design, 100,200 )

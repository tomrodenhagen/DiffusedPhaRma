...
drift =function(t, state){return(-state) }
diff =function(t, state){return(0.1) }
...
png(file="./plots/vis_simulation.png", width=9, height=3,
...
plot(data_h01$t,data_h01$x,type="l", xlab="t", ylab="X", main="h=0.5",cex.main=2.5)
plot(data_h001$t,data_h001$x,type="l", xlab="t", ylab="X", main="h=0.05",cex.main=2.5)
plot(data_h0001$t,data_h0001$x,type="l", xlab="t", ylab="X", main="h=0.005",cex.main=2.5)
dev.off()
